...
class TimelogTest < Test::Unit::TestCase
  def setup
    ...
    ENV["TL_DIR"] = "."
    # assert_equal("", `ruby timelog.rb -u fred -h 6 proj1`)
    # assert_equal("", `ruby timelog.rb -u jim -h 7 proj1`)
    # assert_equal("", `ruby timelog.rb -u alice -h 4.5 proj1`)
    `ruby timelog.rb -u fred -h 6 proj1`
    `ruby timelog.rb -u jim -h 7 proj1`
    `ruby timelog.rb -u alice -h 4.5 proj1`
  end
